...
const featured = [
  { name: 'Passionate-Paris', sub: 'France', img: 'https://images.unsplash.com/photo-1499856871958-5b9357976b82?w=400&auto=format&fit=crop' },
  { name: 'Netherlands', sub: 'Amsterdam', img: 'https://images.unsplash.com/photo-1512470876302-972faa2aa9a4?w=400&auto=format&fit=crop' },
  { name: 'Himachal', sub: 'India', img: 'https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?w=400&auto=format&fit=crop' },
  { name: 'Australia', sub: 'Sydney', img: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=400&auto=format&fit=crop' },
  { name: 'Bali', sub: 'Indonesia', img: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=400&auto=format&fit=crop' },
  { name: 'Dubai', sub: 'UAE', img: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=400&auto=format&fit=crop' },
  { name: 'Switzerland', sub: 'Europe', img: 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=400&auto=format&fit=crop' },
  { name: 'Thailand', sub: 'Asia', img: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=400&auto=format&fit=crop' },
]
      ...
      <section ref={destRef} className="py-14 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {featured.map((d) => (
              <Link key={d.name} to="/booking" className="dest-card relative rounded-2xl overflow-hidden h-44 group">
                ...
                <div className="absolute bottom-0 left-0 p-4">
                  ...
                  <p className="text-gray-300 text-xs">{d.sub}</p>
                </div>
              </Link>
            ))}
          </div>
