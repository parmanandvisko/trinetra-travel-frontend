...
const blogs = [
  { id: 1, title: 'The Ultimate Guide to Traveling', excerpt: 'Discover expert tips, top destinations, budget hacks, and everything you need for a perfect trip.', date: 'May 20, 2025', image: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=500&auto=format&fit=crop' },
  { id: 2, title: 'Hidden Gems You Must Visit', excerpt: 'Explore offbeat places that offer unique experiences away from the crowds.', date: 'May 18, 2025', image: 'https://images.unsplash.com/photo-1501854140801-50d01698950b?w=500&auto=format&fit=crop' },
  { id: 3, title: 'Adventure Travel Made Easy', excerpt: 'Your guide to thrilling adventures and unforgettable travel experiences.', date: 'May 15, 2025', image: 'https://images.unsplash.com/photo-1527004013197-933b09c3b0e9?w=500&auto=format&fit=crop' },
  { id: 4, title: 'Packing Tips for Every Traveler', excerpt: 'Smart packing tips to make your journey comfortable and hassle-free.', date: 'May 12, 2025', image: 'https://images.unsplash.com/photo-1553361371-9b22f78e8b1d?w=500&auto=format&fit=crop' },
]
    ...
    <section ref={container} className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bs-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {blogs.map((blog) => (
            <div key={blog.id} className="bs-card bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
