        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div ref={gridRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {loading ? (
              ...
              filtered.map((pkg) => (
                <div key={pkg._id} role="button" tabIndex={0} onClick={() => navigate(`/packages/${pkg._id}`)} onKeyDown={(e) => e.key === 'Enter' && navigate(`/packages/${pkg._id}`)} className="int-card bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow group cursor-pointer">
